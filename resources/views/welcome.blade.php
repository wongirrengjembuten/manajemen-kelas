...
<head>
    ...
    <title>Sistem Informasi Nilai Akademik - {{ config('app.name', 'SINA') }}</title>
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <h1 class="mb-1 font-medium">Welcome to SINA</h1>
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Sistem Informasi Nilai Akademik (SINA) helps you
                    manage class activities and student grading efficiently.</p>

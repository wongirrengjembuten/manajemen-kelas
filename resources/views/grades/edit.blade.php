                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" id="type"
                                    ...
                                    <option value="Assignment"
                                        {{ old('type', $grade->type) == 'Assignment' ? 'selected' : '' }}>Assignment
                                    </option>
                                    <option value="Quiz" {{ old('type', $grade->type) == 'Quiz' ? 'selected' : '' }}>Quiz
                                    </option>
                                    <option value="Exam" {{ old('type', $grade->type) == 'Exam' ? 'selected' : '' }}>Exam
                                    </option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
